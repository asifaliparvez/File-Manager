                ...
                if (folderRadioBtn.isChecked){
                    ...
                    if (file.exists()){
                        ...
                        if (Files.createFolder(path, editText.text.toString(), fragment.requireContext())){
                            ...
                            Toast.makeText(fragment.requireContext(), "${editText.text} Folder Created", Toast.LENGTH_SHORT)
                                .show()
                            alertDialog.dismiss()
                        }else{
                            Toast.makeText(fragment.requireContext(), "${editText.text} Folder Not Created", Toast.LENGTH_SHORT)
                                .show()
                        }
                    }
                    ...
                    if (file.exists()){
                        editText.error = "File Already Exists!"
                            ...
                            if(Files.createFile(path, editText.text.toString(), fragment.requireContext())){
                                ...
                                Toast.makeText(fragment.requireContext(), "File Not Created", Toast.LENGTH_SHORT).show()
                            }
                    ...
                    Toast.makeText(fragment.requireContext(), "Please Select A Type", Toast.LENGTH_SHORT).show()
                }
